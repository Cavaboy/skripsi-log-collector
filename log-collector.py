...
ROUTERS = [
    ...
    {"name": "R-Core-1", "ip": "10.255.255.11"},
    {"name": "R-Core-2", "ip": "10.255.255.12"}
]
...
def fetch_logs(router):
    ...
    try:
        ...
        # Jika ID dari API sekarang lebih kecil dari last_seen_id,
        # memori log router kemungkinan ter-reset (crash/reboot).
        # ---------------------------------------------
        if raw_data_sorted:
