...
if __name__ == "__main__":
    ...
    # Logs from the user's screenshot/dataset
    targets = [
        "ospf-1 { version: 2 router-id: 1.1.1.1 } area { 0.0.0.0 } created",
        "ospf-1 { version: 2 router-id: 1.1.1.1 } area-0 { 0.0.0.0 } interface { broadcast 1.1.1.1%loopback } state change to Waiting",
        "ospf-1 { version: 2 router-id: 1.1.1.1 } area-0 { 0.0.0.0 } interface { broadcast 1.1.1.1%loopback } neighbor election"
    ]
